...
# ISLE Configuration
# Copy the value of DRUPAL_DB from the new_env_template.env and paste it into the '' below for the database e.g 'database' => 'institution_db',
# Copy the value of DRUPAL_DB_USER from the new_env_template.env between the '' below for the username e.g 'username' => 'institution_db_user',
# Copy the value of DRUPAL_DB_PASS from the new_env_template.env between the '' below for the password e.g 'password' => 'yourpasswordhere',
 ...
 *
 * # ISLE Configuration - Replace the value below with the value of DRUPAL_HASH_SALT from the new_env_template.env */
$drupal_hash_salt = '';
