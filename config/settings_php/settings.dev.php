...
# ISLE Configuration
# Copy the value of DRUPAL_DB from the dev.env and paste it into the '' below for the database e.g 'database' => 'institution_db',
# Copy the value of DRUPAL_DB_USER from the dev.env between the '' below for the username e.g 'username' => 'institution_db_user',
# Copy the value of DRUPAL_DB_PASS from the dev.env between the '' below for the password e.g 'password' => 'yourpasswordhere',

$databases['default']['default'] = array(
  'driver' => 'mysql',
  'database' => 'fsu_db',
  'username' => 'fsu_db_user',
  'password' => '2BPxBfDfwj2dj8pLnDpWmJSt2T',
  'host' => 'mysql',
  'prefix' => '',
  'charset' => 'utf8mb4',
  'collation' => 'utf8mb4_general_ci',
 ...
 *
 * # ISLE Configuration - Replace the value below with the value of DRUPAL_HASH_SALT from the dev.env */
$drupal_hash_salt = 'bBfWwJVdnHGzCDCnTNqgHN5r5WKHzWTCk8f45LccDFsGn';
