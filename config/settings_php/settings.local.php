...
$databases['default']['default'] = array(
  ...
  'password' => 'TcSzGVDwHBlsVHtrngQPfx5cmW',
  'host' => 'mysql',
  'prefix' => '',
  'charset' => 'utf8mb4',
  'collation' => 'utf8mb4_general_ci',
...
$drupal_hash_salt = 'R62S8vXJLV5T2wCZNS3QMN79nmN9zCwtqjHLGLsx4FhzZ';
...
# to the internet. 
# $conf['drupal_http_request_fails'] = FALSE;# BD Theme disables email sending by default. Uncomment the following line to enable email.
# $conf['development_environment'] = 0;
